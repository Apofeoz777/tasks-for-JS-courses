...
function minMax() {
    min = arguments[0]; // Присваиваем первый аргумент переменной min
    max = arguments[0]; // Присваиваем первый аргумент переменной max
  
    for (let i = 1; i < arguments.length; i++) {
      if (arguments[i] < min) {
        min = arguments[i]; // Обновляем значение минимального элемента
      }
      if (arguments[i] > max) {
        max = arguments[i]; // Обновляем значение максимального элемента
      }
    }
